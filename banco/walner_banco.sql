...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_tipo_usuario` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tb_tipo_usuario` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_usuario` (
  ...
  CONSTRAINT `fk_tb_usuario_tb_tipo_usuario1`
    ...
    REFERENCES `mydb`.`tb_tipo_usuario` (`idt_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `mydb`.`tb_poema`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_poema` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tb_poema` (
  ...
  CONSTRAINT `fk_tb_poema_tb_autor`
    ...
    REFERENCES `mydb`.`tb_autor` (`idt_autor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_poema_Categoria1`
    FOREIGN KEY (`cod_categoria`)
    REFERENCES `mydb`.`tb_categoria` (`idt_categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_grava_MP3`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_grava_MP3` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tb_grava_MP3` (
  ...
  CONSTRAINT `fk_tb_grava_MP3_tb_poema1`
    ...
    REFERENCES `mydb`.`tb_poema` (`idt_poema`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_avalia_MP3`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_avalia_MP3` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tb_avalia_MP3` (
  ...
  CONSTRAINT `fk_tb_avalia_MP3_tb_grava_MP31`
    ...
    REFERENCES `mydb`.`tb_grava_MP3` (`idt_gravacao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
